...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    public frmPrincipal() {
        ...
        tblLutador.getColumnModel().getColumn(4).setCellRenderer(new CustomRenderer());
        tblLutador.getColumnModel().getColumn(5).setCellRenderer(new CustomRenderer());
    }
    ...
    private void apagarLutador() {
       ...
       private void apagarLuta() {
        try {
            ...
            boolean aprovada = (Boolean) modeloLuta.getValueAt(tblLuta.getSelectedRow(), 5);
            if (!aprovada) {
    ...
    private void initComponents() {
        ...
        tblLutador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Nacionalidade", "Idade", "Altura", "Peso", "Categoria", "Vitórias", "Derrotas", "Empates"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Float.class, java.lang.Float.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class
            };
        ...
        if (tblLutador.getColumnModel().getColumnCount() > 0) {
            ...
            tblLutador.getColumnModel().getColumn(7).setMaxWidth(50);
            tblLutador.getColumnModel().getColumn(8).setMaxWidth(60);
            tblLutador.getColumnModel().getColumn(9).setMaxWidth(60);
        }
        ...
        tblLuta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data/Hora", "Desafiado", "Desafiante", "Partidas", "Aprovada", "Vencedor"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Boolean.class, java.lang.String.class
            };
            boolean[] canEdit = new boolean [] {
