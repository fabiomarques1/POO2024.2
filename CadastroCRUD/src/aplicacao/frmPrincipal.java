   ...
   SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
    ...
    private void initComponents() {
        ...
        if (tblPessoa.getColumnModel().getColumnCount() > 0) {
            tblPessoa.getColumnModel().getColumn(0).setMinWidth(50);
            tblPessoa.getColumnModel().getColumn(0).setMaxWidth(50);
            tblPessoa.getColumnModel().getColumn(1).setMinWidth(290);
            tblPessoa.getColumnModel().getColumn(1).setMaxWidth(300);
        }
